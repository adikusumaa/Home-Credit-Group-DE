...
def process_application_data(spark):
    try:
        ...
        logger.info("application_s processing completed successfully")
        
    except Exception as e:
        logger.error(f"Error processing application_s: {str(e)}")
        raise

if __name__ == "__main__":
    spark = SparkSession.builder.appName("application_s").getOrCreate()
